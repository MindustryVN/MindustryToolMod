...
/**
 * Pure parser for crash file timestamps.
 * Single Responsibility: convert {@link Fi} filename to epoch millis.
 * Thread-safe — uses {@link DateTimeFormatter} instead of {@code SimpleDateFormat}.
 */
public final class CrashTimestampParser {

    private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("MM_dd_yyyy_HH_mm_ss",
            Locale.ROOT);
    ...
    /**
     * Parses timestamp from a crash file name.
     * Supports {@code crash-report-MM_dd_yyyy_HH_mm_ss} and {@code crash_<epochMillis>}.
     *
