                                        ...
                                        .children(() -> {
                                            row()
                                                    ...
                                                    .children(() -> {
                                                        ...
                                                        text(feature.getOpacityConfig().signal().map(v -> String.format("%.0f%%", v * 100)));
                                                    });
                                            ...
                                            row()
                                                    ...
                                                    .children(() -> {
                                                        ...
                                                        text(feature.getScaleConfig().signal().map(v -> String.format("%.0f%%", v * 100)));
                                                    });
                                            ...
                                            for (Feature f : FeatureManager.getFeatures()) {
                                                ...
                                                checkbox(f.getName(), feature.isFeatureVisible(meta.getId()), visible -> feature.setFeatureVisible(meta.getId(), visible));
                                            }
