...
/**
 * Declarative dialog component for Solim. Extends Arc Dialog while providing full declarative
...
public class SolimDialog extends Dialog implements Disposable, arc.util.Disposable {
	 ...
	 * specified Arc event fires. The event listener is automatically cleaned up when this dialog is
	 * disposed.
	 */
	 ...
	 * fires. The event listener is automatically cleaned up when this dialog is disposed.
	 */
