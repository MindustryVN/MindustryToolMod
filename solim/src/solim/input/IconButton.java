...
/**
 * Button widget displaying an icon drawable with support for sizing, tooltips, reactive state, and
 * click event bubbling isolation.
 */
public final class IconButton implements Component, Disposable {
	...
	public static class SizedImageButton extends ImageButton {
		...
		public SizedImageButton(Drawable icon, ImageButtonStyle style) {
			super(
					icon != null ? icon : new TextureRegionDrawable(new TextureRegion()),
