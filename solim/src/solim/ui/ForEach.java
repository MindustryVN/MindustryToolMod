...
public final class ForEach<T, K> extends BaseComponent {
    ...
    public ForEach(Readable<? extends Iterable<T>> collection, Function<T, K> keyExtractor, Function<T, Component> itemFactory) {
        this.collection = collection;
        this.keyExtractor = keyExtractor;
        this.itemFactory = itemFactory;
    }

    public static <T, K> ForEach<T, K> of(Readable<? extends Iterable<T>> collection, Function<T, K> keyExtractor, Function<T, Component> itemFactory) {
